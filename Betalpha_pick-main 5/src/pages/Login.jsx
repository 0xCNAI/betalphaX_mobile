...
const Login = () => {
  ...
  const { signInWithGoogle, loginAsPreviewUser } = useAuth();
    ...
    <div className="auth-container">
      <div className="auth-card">
        ...
        <div className="auth-actions">
          {/* Check for Preview Environment: Env Var OR Vercel Preview URL (excluding prod domains) */}
          {(import.meta.env.VITE_VERCEL_ENV === 'preview' ||
            (window.location.hostname.endsWith('.vercel.app') &&
              !['betalpha-pick.vercel.app', 'betalphax.vercel.app', 'betalphapick.web.app'].includes(window.location.hostname))) ? (
            <button onClick={handlePreviewLogin} className="btn-google" style={{ background: '#3b82f6', color: 'white' }}>
              <LogIn size={20} />
              Enter Preview Mode
            </button>
          ) : (
